...
from utils.data_utils import save_gaussians_to_ply
...
def setup_snapshot_image_grid(training_set, random_seed=0):
    ...
    #     # print(i, training_set[i].shape)
    #     images, segs, labels = training_set[i]
    #     # images, labels = zip(*training_set[i])
    #     print('i', i)
    #     # print(images)
    #     # print('labels', labels)
    # print('Finish!')
    ...
    # print('np.stack(images)', np.stack(images))
...
def training_loop(
    ...
    while True:
        ...
        # print('len(phases)', len(phases))  # 4
        # print('len(all_gen_z)', len(all_gen_z))  # 4
        # print('len(all_gen_c)', len(all_gen_c))  # 4
        print('batch_idx', batch_idx)
        print('cur_tick', cur_tick)
        print('Execute training phases')
        for phase, phase_gen_z, phase_gen_c in zip(phases, all_gen_z, all_gen_c):
            # print('phase', phase)
            # print('phase_gen_c.shape', phase_gen_c.shape)
            # print('phase_gen_z.shape', phase_gen_z.shape)
            if batch_idx % phase.interval != 0:  # phase.interval=1
                continue
            if phase.start_event is not None:  # None
