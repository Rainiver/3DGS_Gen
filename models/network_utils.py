...
class HierarchicalPoseEncoder(nn.Module):
    ...
    def forward(self, rots, Jtrs, skinning_weight=None):
        ...
        # print('global_feat.device', global_feat.device)
        self.to(global_feat.device)
        # self.layer_0.weight.data = self.layer_0.weight.data.to(global_feat.device)
        # self.layer_0.bias.data = self.layer_0.bias.data.to(global_feat.device)
